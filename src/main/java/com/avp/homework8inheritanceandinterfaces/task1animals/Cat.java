...
public class Cat extends Mammal{
    ...
    private int amountMustache;
    protected String lastName1;
    public int age1;

    public Cat(String name, String color, int age, int amountLeg, int amountArm, String lastName, int amountMustache, String lastName1, int age1) {
    ...
    public boolean equals(Object o) {
        ...
        Cat cat = (Cat) o;
        return age1 == cat.age1 && Objects.equals(amountMustache, cat.amountMustache) && Objects.equals(lastName1, cat.lastName1);
    }
